...
export const walletMessages: Messages = {
    en: {
        ...
        stocks: 'Stocks',
        tileStocksHint: 'Tokenised shares and funds, on Robinhood Chain',
        stocksIntro:
            'A share held by a broker, with a token on Robinhood Chain standing for it. It is not equity — no vote, no claim on the company — and here the only thing behind it is whoever will trade it in this chain’s pools.',
        stocksCount: '{count} listed · quoted by the issuer',
        stocksSearch: 'find a ticker or a company…',
        stocksNone: 'Nothing here matches that.',
        stocksEquities: 'Companies',
        stocksFunds: 'Funds',
        stocksHalted: 'HALTED',
        stocksDay: 'Day {low} – {high}',
        stocksNoPrice: 'The issuer’s quote could not be read.',
        stocksQuotedAt: 'Quoted {at} · Robinhood',
        stocksTrade: 'Trade',
        stocksHeld: 'You hold {amount}',
        stocksAdd: 'Add to wallet',
        stocksAdded: 'In your wallet',
        stocksMultiplier: '{value} shares per token',
        stocksFailed: 'Prices could not be loaded.',
        stocksVenue: 'Traded in this chain’s own pools · Uniswap v3',
        stocksVolume: '{value} shares traded today',
        ...
        feeBasisSplRent: 'signature + rent for a token account',
        ...
        routeUnlisted: 'From the pools',
        routeListTop: 'What this network routes, deepest markets first.',
        routeListFound:
            'Found in the router’s catalogue and in the pools, deepest first.',
        chartShow: 'Show the chart →',
        chartHide: 'Hide the chart',
        chartSource: 'DexScreener · {dex} pool',
        routeDepth: 'liquidity {liquidity}',
        routeUnreadableToken:
            'This network does not answer for that address as a token.',
    ...
    ru: {
        ...
        stocks: 'Акции',
        tileStocksHint: 'Токенизированные акции и фонды в Robinhood Chain',
        stocksIntro:
            'Акция лежит у брокера, а в Robinhood Chain её представляет токен. Это не доля в компании — ни голоса, ни требований к ней, — и здесь за токеном стоит только тот, кто готов торговать им в пулах этой сети.',
        stocksCount: '{count} в списке · котировку даёт эмитент',
        stocksSearch: 'тикер или название компании…',
        stocksNone: 'Ничего не нашлось.',
        stocksEquities: 'Компании',
        stocksFunds: 'Фонды',
        stocksHalted: 'ТОРГИ ОСТАНОВЛЕНЫ',
        stocksDay: 'День {low} – {high}',
        stocksNoPrice: 'Котировку эмитента прочитать не удалось.',
        stocksQuotedAt: 'Котировка {at} · Robinhood',
        stocksTrade: 'Обменять',
        stocksHeld: 'У вас {amount}',
        stocksAdd: 'Добавить в кошелёк',
        stocksAdded: 'Уже в кошельке',
        stocksMultiplier: '{value} акции на токен',
        stocksFailed: 'Цены не загрузились.',
        stocksVenue: 'Торгуется в пулах этой сети · Uniswap v3',
        stocksVolume: '{value} акций за сегодня',
        ...
        feeBasisSplRent: 'подпись + рента за токен-счёт',
        ...
        swapAppFee: 'Комиссия Cyberia · {pct}%',
        ...
        routeUnlisted: 'Из пулов',
        routeListTop:
            'Что маршрутизируется в этой сети, сверху — глубокие рынки.',
        routeListFound:
            'Найдено в каталоге маршрутизатора и в пулах, сверху — глубокие.',
        chartShow: 'Показать график →',
        chartHide: 'Скрыть график',
        chartSource: 'DexScreener · пул {dex}',
        routeDepth: 'ликвидность {liquidity}',
        routeUnreadableToken: 'Сеть не отвечает по этому адресу как по токену.',
    ...
    zh: {
        ...
        marketsNone: '没有匹配的结果。',
        stocks: '股票',
        tileStocksHint: 'Robinhood Chain 上的代币化股票与基金',
        stocksIntro:
            '股票由券商持有，Robinhood Chain 上的代币代表它。它不是股权——没有投票权，也没有对公司的请求权——在这里，代币背后只有愿意在本链池子里与你成交的人。',
        stocksCount: '共 {count} 支 · 报价来自发行方',
        stocksSearch: '搜索代码或公司名…',
        stocksNone: '没有匹配的结果。',
        stocksEquities: '公司',
        stocksFunds: '基金',
        stocksHalted: '已停牌',
        stocksDay: '当日 {low} – {high}',
        stocksNoPrice: '无法读取发行方的报价。',
        stocksQuotedAt: '报价时间 {at} · Robinhood',
        stocksTrade: '兑换',
        stocksHeld: '你持有 {amount}',
        stocksAdd: '添加到钱包',
        stocksAdded: '已在钱包中',
        stocksMultiplier: '每个代币 {value} 股',
        stocksFailed: '价格加载失败。',
        stocksVenue: '在本链池子中交易 · Uniswap v3',
        stocksVolume: '今日成交 {value} 股',
        ...
        routeUnverified: '未验证',
        routeUnlisted: '来自流动池',
        routeListTop: '该网络可路由的代币，流动性最深的在前。',
        routeListFound: '来自路由器目录与流动池，流动性最深的在前。',
        chartShow: '显示图表 →',
        chartHide: '隐藏图表',
        chartSource: 'DexScreener · {dex} 池',
        routeDepth: '流动性 {liquidity}',
        routeUnreadableToken: '该网络不认为这个地址是代币。',
        routeQuote: '寻找最优路由',
        routeQuoting: '寻找中…',
