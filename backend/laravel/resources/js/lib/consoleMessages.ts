...
export const consoleMessages: Messages = {
    en: {
        'task.files.title': 'Attachments',
        'task.files.hint': 'Files and media live with the brief',
        'task.files.choose': 'Choose files',
        'task.files.caption': 'Caption for this upload',
        'task.files.upload': 'Attach files',
        'task.files.uploading': 'Uploading…',
        'task.files.comment': 'Comment on this attachment…',
        'task.files.commentSend': 'Send',
        'task.files.delete': 'Delete attachment',
        'task.files.deleteConfirm': 'Delete {name}?',
        'profile.title': 'Operator profile',
        'profile.intro': 'Your private CRM identity, activity and appearance.',
        ...
        'profile.register': 'Register CRM profile',
        'profile.activity': 'Activity',
        'profile.completed': 'Completed tasks',
        'profile.active': 'Active tasks',
        'profile.created': 'Created tasks',
        'profile.comments': 'Comments · 30 days',
        'profile.rank': 'Rank',
        'profile.theme': 'CRM theme',
        'profile.security': 'Account security',
        'profile.back': 'Back to CRM',
        /* chrome */
        'nav.now': 'Now',
        'nav.people': 'Leads',
        'nav.tasks': 'Tasks',
        ...
        'people.next.closed': 'Work closed',
        'people.next.overdue': 'Overdue next step',
        'people.next.reply': 'Review their message and reply',
        'people.next.planned': 'Next step scheduled',
        'people.next.plan': 'Schedule the next contact',
        'people.next.first': 'Make first contact',
        'people.noDate': 'No date',
        'people.noOwner': 'No owner',
        'people.lastIn': 'Last recorded message is theirs',
        'people.lastOut': 'Last recorded message is ours',
        'people.doTask': 'Open task',
        'people.workLead': 'Work with lead',
        'people.planWithMessage': 'Schedule a next step with this record',
        'people.followTitle': 'What to do next',
        'people.followWhen': 'When',
        'people.followWho': 'Owner',
        'people.saveAndPlan': 'Record and schedule',
        'segment.first_contact': 'First contact',
        'rule.first_contact': 'New leads with no recorded messages',
        'segment.needs_reply': 'Their message is last',
        'rule.needs_reply':
            'Last recorded message is inbound; lost contacts excluded',
        'segment.no_next_step': 'No next step',
        'rule.no_next_step':
            'Recorded correspondence but no active task; lost contacts excluded',
        'people.happening': 'Next steps',
        ...
        'people.rest': 'choose a segment to work through the next actions',
        ...
        'push.nobody':
            'Nobody has subscribed yet. Site accounts use the bell in the header; wallet installations turn it on in Wallet → Security.',
    ...
    ru: {
        'task.files.title': 'Вложения',
        'task.files.hint': 'Файлы и медиа хранятся вместе с описанием',
        'task.files.choose': 'Выбрать файлы',
        'task.files.caption': 'Комментарий к этим файлам',
        'task.files.upload': 'Прикрепить файлы',
        'task.files.uploading': 'Загрузка…',
        'task.files.comment': 'Комментарий к этому вложению…',
        'task.files.commentSend': 'Отправить',
        'task.files.delete': 'Удалить вложение',
        'task.files.deleteConfirm': 'Удалить {name}?',
        'profile.title': 'Профиль оператора',
        'profile.intro': 'Ваш профиль, активность и оформление внутри CRM.',
        'profile.name': 'Имя',
        'profile.role': 'Роль',
        'profile.bio': 'О себе',
        ...
        'profile.register': 'Зарегистрировать профиль CRM',
        'profile.activity': 'Активность',
        'profile.completed': 'Завершено задач',
        'profile.active': 'Активных задач',
        'profile.created': 'Создано задач',
        'profile.comments': 'Комментарии · 30 дней',
        'profile.rank': 'Ранг',
        'profile.theme': 'Тема CRM',
        'profile.security': 'Безопасность аккаунта',
        'profile.back': 'Назад в CRM',
        /* chrome */
        'nav.now': 'Сейчас',
        'nav.people': 'Лиды',
        'nav.tasks': 'Задачи',
        ...
        'people.next.closed': 'Работа закрыта',
        'people.next.overdue': 'Следующий шаг просрочен',
        'people.next.reply': 'Разобрать сообщение и ответить',
        'people.next.planned': 'Следующий шаг назначен',
        'people.next.plan': 'Назначить следующий контакт',
        'people.next.first': 'Связаться впервые',
        'people.noDate': 'Без даты',
        'people.noOwner': 'Без ответственного',
        'people.lastIn': 'Последнее записанное сообщение — от лида',
        'people.lastOut': 'Последнее записанное сообщение — наше',
        'people.doTask': 'К задаче',
        'people.workLead': 'Работать с лидом',
        'people.planWithMessage': 'Вместе с записью назначить следующий шаг',
        'people.followTitle': 'Что сделать дальше',
        'people.followWhen': 'Когда',
        'people.followWho': 'Ответственный',
        'people.saveAndPlan': 'Записать и запланировать',
        'segment.first_contact': 'Первый контакт',
        'rule.first_contact': 'Новые лиды без записанной переписки',
        'segment.needs_reply': 'Последнее сообщение от лида',
        'rule.needs_reply':
            'Последнее записанное сообщение — входящее; закрытые лиды исключены',
        'segment.no_next_step': 'Без следующего шага',
        'rule.no_next_step':
            'Переписка есть, открытой задачи нет; закрытые лиды исключены',
        'people.happening': 'Что сделать дальше',
        ...
        'people.rest': 'выберите сегмент, чтобы разобрать следующие действия',
        ...
        'push.nobody':
            'Пока никто не подписался. Аккаунты сайта — колокольчик в шапке, установки кошелька — Кошелёк → Безопасность.',
