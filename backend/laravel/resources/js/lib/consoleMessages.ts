...
export const consoleMessages: Messages = {
    en: {
        ...
        'push.nobody': 'Nobody has subscribed yet. The bell only appears for a signed-in account on the site.',
    ...
    ru: {
        ...
        'push.nobody': 'Пока никто не подписался. Колокольчик виден только залогиненному аккаунту на сайте.',
