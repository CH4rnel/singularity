/**
 * Number/price formatting shared by the DEX surfaces (launchpad + swap
 * market chart). Ritual prices span from 1e-9 (launchpad supply) to
 * thousands, so both helpers are magnitude-aware.
 */
