...
/**
 * Deploys the three AI-themed OZ-style tokens (HERMES, CLAUDE, CHATGPT) and
 * writes their addresses back into deployments/cyberia-tokens.json.
 *
 * Env: DEPLOYER_PK (required), CYBERIA_RPC_URL (optional),
 *      TOKEN_OWNER (optional, defaults to deployer).
 */

const SYMBOLS = ["HERMES", "CLAUDE", "CHATGPT", "OPENCLAW"] as const;
