...
const artifact = JSON.parse(
  fs.readFileSync("./artifacts/contracts/KARASIQUE.sol/KARASIQUE.json", "utf8"),
);
...
// Optional override: KARASIQUE_OWNER env var (defaults to deployer).
const owner = (process.env.KARASIQUE_OWNER ??
  walletClient.account.address) as `0x${string}`;

console.log("Deploying KARASIQUE (KRSQ)...");
...
console.log("KARASIQUE deployed at:", receipt.contractAddress);
