...
const artifact = JSON.parse(
  fs.readFileSync(
    "./artifacts/contracts/CyberSolBurnSwap.sol/CyberSolBurnSwap.json",
    "utf8",
  ),
);
...
console.log("Deploying CyberSolBurnSwap (1000 CYBER.sol -> 1 CYBER, burns input)...");
...
console.log("CyberSolBurnSwap deployed at:", receipt.contractAddress);
