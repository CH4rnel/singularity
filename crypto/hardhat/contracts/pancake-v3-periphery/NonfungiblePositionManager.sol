...
import '../pancake-v3-core/libraries/FixedPoint128.sol';
    ...
    SelfPermit
{
    ...
    ) ERC721Permit('Cyberia V3 Positions NFT-V1', 'CYB-V3-POS', '1') PeripheryImmutableState(_deployer, _factory, _WETH9) {
