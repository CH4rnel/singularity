...
interface IPancakeV3Factory {
    ...
    /// @notice Set the swap fee of an existing pool
    /// @dev The pool's fee tier -- the value in its CREATE2 salt and in `getPool` -- is not changed
    /// by this, and neither is its tick spacing. Only what the pool charges per swap changes.
    /// @param pool The pool to retune
